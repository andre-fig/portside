  ...
  head: () => ({
    meta: [
      ...
      { title: "Portside — Mais jogos da sua Steam. Agora no Mac." },
      {
        name: "description",
        content:
          "Portside prepara automaticamente o ambiente de compatibilidade para você abrir a Steam do Windows e jogar no seu Mac com Apple Silicon.",
      },
      { name: "author", content: "Portside" },
      { property: "og:title", content: "Portside — Mais jogos da sua Steam. Agora no Mac." },
      {
        property: "og:description",
        content: "Instale, abra a Steam e jogue no seu Mac com Apple Silicon.",
      },
