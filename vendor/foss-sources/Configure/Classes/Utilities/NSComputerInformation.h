...
#define IS_SYSTEM_MAC_OS_15_0_OR_SUPERIOR   [NSComputerInformation isSystemMacOsEqualOrSuperiorTo:@"15.0"]   // Sequoia
...
#define IS_SYSTEM_MAC_OS_SEQUOIA_OR_SUPERIOR        IS_SYSTEM_MAC_OS_15_0_OR_SUPERIOR
