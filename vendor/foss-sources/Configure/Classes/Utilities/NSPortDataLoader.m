...
{
    NSString* QuitScriptPath = [NSString stringWithFormat:@"%@/Contents/Resources/Scripts/QuitScript",
                                        port.path];
    if ([[NSFileManager defaultManager] fileExistsAtPath:QuitScriptPath])
    {
        NSString* text = [NSString stringWithContentsOfFile:QuitScriptPath encoding:NSASCIIStringEncoding error:nil];
