...
| [Build Landing](../.github/workflows/build-landing.yml)                            | Landing/workflow changes on PR/push or dispatch; Bun 1.2.21 install, lint, typecheck, build and `.output` artifact, retained 14 days.                                     | Named as Railway deploy gate; provider-side deploy configuration is external.                                                                 |
...
| [Verify Railway](../.github/workflows/deploy-railway.yml)                          | Successful CI plus backend/deploy changes; polls configured API `/health`.                                                                                                | Checks availability only; it does not deploy or prove the exact commit is running.                                                            |
| [Sync Upstreams](../.github/workflows/sync-upstreams.yml)                          | Daily 03:17 UTC or dispatch; syncs sources and maintains a PR.                                                                                                            | May commit/push its automation branch and close obsolete PRs. Never merges or publishes runtime artifacts.                                    |
