...
| FreeType                           | pinned in upstream/dependencies.json | Source archive and SHA-256 in `upstream/dependencies.json` | Built for x86_64 and bundled with the engine under the FreeType License; FTL.TXT and LICENSE.TXT included |
